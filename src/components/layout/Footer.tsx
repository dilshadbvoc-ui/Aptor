...
export function Footer() {
    return (
        <footer className="bg-green-800 border-t border-green-600 mobile-safe-area-bottom">
            <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-8 sm:py-12 lg:py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                    ...
                    <div className="sm:col-span-2 lg:col-span-1">
                        <Link href="/" className="flex items-center mb-4 sm:mb-6 group">
                            <div className="relative">
                                <img 
                                    ...
                                    className="w-14 h-14 sm:w-16 sm:h-16 rounded-lg sm:rounded-xl object-cover shadow-lg group-hover:shadow-green-400/25 transition-all duration-300"
                                />
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            <div className="flex items-center gap-2 sm:gap-3 text-green-100 hover:text-yellow-400 transition-colors">
                                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-green-700 rounded-md sm:rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        <ul className="space-y-2 sm:space-y-3">
                            {quickLinks.map((link, index) => (
                                <li key={`${link.href}-${index}`}>
                                    <Link 
                                        href={link.href} 
                                        className="text-green-200 hover:text-yellow-400 transition-colors flex items-center gap-2 group text-sm min-h-[32px] py-1"
                                    >
                ...
                <div className="pt-6 sm:pt-8 mt-6 sm:mt-8 border-t border-green-600">
                    <div className="flex flex-col space-y-4 sm:space-y-6">
                            ...
                            <div className="flex items-center space-x-3 sm:space-x-4">
                                {[
                                    ...
                                    <Link 
                                        key={index}
                                        href={social.href} 
                                        className="w-8 h-8 sm:w-10 sm:h-10 bg-green-700 rounded-lg flex items-center justify-center text-green-200 hover:text-yellow-400 hover:bg-green-600 transition-all duration-300 group min-w-[32px] min-h-[32px]"
                                    >
                        ...
                        <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:justify-between sm:items-center">
                            <p className="text-green-200 text-xs sm:text-sm text-center sm:text-left flex items-center justify-center sm:justify-start gap-2">
                            ...
                            <div className="flex justify-center sm:justify-end gap-4 sm:gap-6 text-xs sm:text-sm">
                                <Link href="/privacy-policy" className="text-green-200 hover:text-yellow-400 transition-colors min-h-[32px] flex items-center">
                                    Privacy Policy
                                </Link>
                                <Link href="/terms" className="text-green-200 hover:text-yellow-400 transition-colors min-h-[32px] flex items-center">
                                    Terms of Service
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="text-center mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-green-700">
                        <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-green-700 border border-green-600 rounded-full">
                            <Crown className="w-3 h-3 sm:w-4 sm:h-4 text-yellow-400" />

...
export const courseSchema = z.object({
  ...
  college: z.string().regex(/^[0-9a-fA-F]{24}$/, 'Invalid college ID').optional().or(z.literal("")),
  university: z.string().regex(/^[0-9a-fA-F]{24}$/, 'Invalid university ID').optional().or(z.literal("")),
